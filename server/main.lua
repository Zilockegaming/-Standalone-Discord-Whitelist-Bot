...
AddEventHandler("qb-ifruitstore:server:PoliceAlertMessage1", function ()
    local data = {displayCode = "10-11A", description = "iFruit Overval", isImportant = 1,
        recipientList = {"police"}, length = "10000", infoM = "fas fa-mobile", info = "iFruit winkel overval gaande..", blipSprite = 619, blipColour = 50, blipScale = 1.0}
...
AddEventHandler("qb-ifruitstore:server:PoliceAlertMessage2", function ()
    local data = {displayCode = "10-11B", description = "Knoeien met de elektriciteitskast", isImportant = 0,
        recipientList = {"police"}, length = "5000", infoM = "fas fa-bolt", info = "Iemand knoeit met de iFruit Store Power Box..", blipSprite = 769, blipColour = 66, blipScale = 0.7}
...
AddEventHandler("qb-ifruitstore:server:PoliceAlertMessage3", function ()
    local data = {displayCode = "10-11C", description = "Stroomstoring", isImportant = 0,
        recipientList = {"police"}, length = "5000", infoM = "fas fa-bolt", info = "Bij de iFruit Store is onverwachts de stroom uitgevallen", blipSprite = 769, blipColour = 66, blipScale = 0.4}
    local dispatchData = {dispatchData = data, caller = "Alarm", coords = vector3(Config.Locations["main"].x, Config.Locations["main"].y, Config.Locations["main"].z)}
    TriggerEvent("wf-alerts:svNotify", dispatchData)
end)
